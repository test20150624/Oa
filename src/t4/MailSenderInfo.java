...
public class MailSenderInfo {
     ...
     * 初始化方法
     */
    public MailSenderInfo(boolean debug) {
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            InternetAddress from = new InternetAddress(" <"+sender_username+">");//MimeUtility.encodeWord("幻影")+
    ...
    public static void main(String[] args) {
    	MailSenderInfo se = new MailSenderInfo(false);
        se.doSendHtmlEmail("邮件主题", "邮件内容aa", "haoliang@miracles.cn");
