...
//        session.setDebug(debug);// 开启后有调试信息
   ...
   MailWithAttachment se = new MailWithAttachment(true);
        File affix = new File("d:\\test201506171137061.jpg");
        se.doSendHtmlEmail("邮件主题", "邮件内容test1018", "liuhl0@126.com", affix);//
    }
   /* public static void ff(String[] args) {

    	MailWithAttachment se = new MailWithAttachment(false);
    	File affix = new File("D:\\51.jpg");
        se.doSendHtmlEmail("邮件主题", "邮件内容aa123", "l.hllhl0@163.com",affix);//haoliang@miracles.cn
